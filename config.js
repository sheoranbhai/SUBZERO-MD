...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~549vUTw8UNf3JbSgopzP",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "919728893187",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Mr Sanju",           // Owner's name
    DEV: process.env.DEV || "919728893187",                     // Developer's contact number
    DEVELOPER_NUMBER: '919728893187@s.whatsapp.net',            // Developer's WhatsApp ID
    ...
    STICKER_NAME: process.env.STICKER_NAME || "Sanju",     // Sticker pack name
